...
#import "TopbooksDelegate.h"

@class ASINetworkQueue;

@interface Topbooks :  NSManagedObject  
{
@private
	ASINetworkQueue *networkQueue;
	UIImage *bookCover;
	NSObject<TopbooksDelegate> *delegate;
}

@property (nonatomic, retain) ASINetworkQueue *networkQueue;
@property (nonatomic, retain) UIImage *bookCover;
@property (nonatomic, assign) NSObject<TopbooksDelegate> *delegate;
