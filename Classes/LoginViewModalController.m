...
@synthesize progressIndicator, managedObjectContext, delegate;
...
@synthesize fetchCount, urlArray;
...
#pragma mark -
#pragma mark LoginViewModalDelegate Methods

-(IBAction)dismissView:(id)sender {
	
		// CHECK IF THERE IS STUFF TO DO BEFORE CLOSING THE WINDOW
	if ([delegate respondsToSelector:@selector(nextSteps)])
		[delegate nextSteps];
	
		// Callback to the delegate to dismiss the modal view
...
- (void)loginRequestFinished:(ASIHTTPRequest *)request
{
	...
	if ([delegate respondsToSelector:@selector(nextSteps)]) 
		...
		NSString *msgString = @"You Are Now Logged In.\n\nPlease Retry Your Last Transaction.";
		[appDelegate alertWithMessage:msgString withTitle:@"WOWIO"];
